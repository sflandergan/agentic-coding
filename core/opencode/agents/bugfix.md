---
description: Investigates bugs from error logs or behavior descriptions, traces root cause through code and data, and produces a structured tracker issue.
mode: all
temperature: 0.1
permission:
  read:
  ...
  bash:
    ...
    # Tracker issues — use issue-tracker scripts for mutations; direct gh/glab mutations are denied
    "gh *": deny
