...
OpenCode task tool:
  ...
  prompt: |
    ...
    **Only flag issues that would cause real problems during implementation.**
    ...
    Before returning, build a private coverage matrix:

    | Input | Plan section/task that covers it | Status |
    |-------|----------------------------------|--------|
    ...
    **Coverage gaps (if any):**
    - [Input source]: [requirement or remark] is not covered by the plan
